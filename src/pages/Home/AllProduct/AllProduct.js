...
const AllProduct = () => {
  return (
    <div className="container">
      <h1 className="text-primary fw-bold mt-4">All Product List</h1>
      <div className="row row-cols-1 g-5 justify-content-evenly">
      <div className="card col-sm-12 col-md-6 col-lg-6 gx-5" style={{width:"20rem"}}>
        ...
        <ul className="list-group list-group-flush">
         ...
         <li className="list-group-item"><Link to="#" className="card-link text-decoration-none fw-bold">Show All</Link></li> 
        </ul>
      </div>
      <div className="card col-sm-12 col-md-6 col-lg-6" style={{width:"20rem"}}>
