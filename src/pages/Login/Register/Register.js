...
const Register = () => {
   ...
   return (
      <div className="text-center container w-25 mx-auto mt-5 pt-3 pb-4 register-div">
         ...
         <form onSubmit={handleRegister} className="form-group">
            ...
            />
            <label
               className={`ps-2 ${signUp ? '' : 'text-danger'}`}
               htmlFor="terms"
            >
               Accept Apple Disttributor Terms and Conditions
            </label>
            <br /> */}
            {/* <input
               disabled={!signUp}
...
<button className='register-btn mx-auto'>
    <span>Continue</span>
